const MODELS = [
  ...
  { value: 'best_1280',             label: '🔬 VisDrone YOLOv8n 1280px', tag: '37% mAP · Ablation A3',  tagColor: 'text-purple-400' },
  { value: 'best_640',              label: '⚗️ VisDrone YOLOv8n 640px',  tag: '22% mAP · Ablation A2',  tagColor: 'text-blue-400' },
